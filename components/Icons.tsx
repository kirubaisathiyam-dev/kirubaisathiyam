...
const emailSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path stroke-dasharray="64" stroke-dashoffset="64" d="M4 5h16c0.55 0 1 0.45 1 1v12c0 0.55 -0.45 1 -1 1h-16c-0.55 0 -1 -0.45 -1 -1v-12c0 -0.55 0.45 -1 1 -1Z"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="64;0"/></path><path stroke-dasharray="24" stroke-dashoffset="24" d="M3 6.5l9 5.5l9 -5.5"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.6s" dur="0.2s" values="24;0"/></path></g></svg>`;
const instagramSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><circle cx="17" cy="7" r="1.5" fill="currentColor" fill-opacity="0"><animate fill="freeze" attributeName="fill-opacity" begin="1.3s" dur="0.15s" values="0;1"/></circle><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path stroke-dasharray="72" stroke-dashoffset="72" d="M16 3c2.76 0 5 2.24 5 5v8c0 2.76 -2.24 5 -5 5h-8c-2.76 0 -5 -2.24 -5 -5v-8c0 -2.76 2.24 -5 5 -5h4Z"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="72;0"/></path><path stroke-dasharray="28" stroke-dashoffset="28" d="M12 8c2.21 0 4 1.79 4 4c0 2.21 -1.79 4 -4 4c-2.21 0 -4 -1.79 -4 -4c0 -2.21 1.79 -4 4 -4"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.7s" dur="0.6s" values="28;0"/></path></g></svg>`;
const youtubeSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" fill-opacity="0" d="M12 11L12 12L12 13z"><animate fill="freeze" attributeName="d" begin="0.6s" dur="0.2s" values="M12 11L12 12L12 13z;M10 8.5L16 12L10 15.5z"/><set fill="freeze" attributeName="fill-opacity" begin="0.6s" to="1"/></path><path fill="none" stroke="currentColor" stroke-dasharray="64" stroke-dashoffset="64" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5c9 0 9 0 9 7c0 7 0 7 -9 7c-9 0 -9 0 -9 -7c0 -7 0 -7 9 -7Z"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="64;0"/></path></svg>`;
const whatsappSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 464 488"><path fill="currentColor" d="M462 228q0 93-66 159t-160 66q-56 0-109-28L2 464l40-120q-32-54-32-116q0-93 66-158.5T236 4t160 65.5T462 228M236 39q-79 0-134.5 55.5T46 228q0 62 36 111l-24 70l74-23q49 31 104 31q79 0 134.5-55.5T426 228T370.5 94.5T236 39m114 241q-1-1-10-7q-3-1-19-8.5t-19-8.5q-9-3-13 2q-1 3-4.5 7.5t-7.5 9t-5 5.5q-4 6-12 1q-34-17-45-27q-7-7-13.5-15t-12-15t-5.5-8q-3-7 3-11q4-6 8-10l6-9q2-5-1-10q-4-13-17-41q-3-9-12-9h-11q-9 0-15 7q-19 19-19 45q0 24 22 57l2 3q2 3 4.5 6.5t7 9t9 10.5t10.5 11.5t13 12.5t14.5 11.5t16.5 10t18 8.5q16 6 27.5 10t18 5t9.5 1t7-1t5-1q9-1 21.5-9t15.5-17q8-21 3-26"/></svg>`;
const copySvg = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path fill="currentColor" fill-opacity="0" stroke-dasharray="66" d="M22 3v14c0 0.55 -0.45 1 -1 1h-14c-0.55 0 -1 -0.45 -1 -1v-14c0 -0.55 0.45 -1 1 -1h14c0.55 0 1 0.45 1 1Z"><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="66;0"/><animate fill="freeze" attributeName="fill-opacity" begin="1.6s" dur="0.15s" to="0.3"/></path><g fill="none"><g stroke-dasharray="10" stroke-dashoffset="10"><path d="M10 6h8"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.7s" dur="0.2s" to="0"/></path><path d="M10 10h8"><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.9s" dur="0.2s" to="0"/></path></g><path stroke-dasharray="8" stroke-dashoffset="8" d="M10 14h5"><animate fill="freeze" attributeName="stroke-dashoffset" begin="1.1s" dur="0.2s" to="0"/></path><path d="M2 6v15c0 0.55 0.45 1 1 1h15" opacity="0"><set fill="freeze" attributeName="opacity" begin="1.4s" to="1"/><animate fill="freeze" attributeName="d" begin="1.4s" dur="0.2s" values="M6 3v14c0 0.55 0.45 1 1 1h14;M2 6v15c0 0.55 0.45 1 1 1h15"/></path></g></g></svg>`;
...
export function SearchIcon(props: IconProps) {
  return <InlineSvgIcon markup={searchSvg} {...props} />;
}

export function SettingsIcon(props: IconProps) {
  return <InlineSvgIcon markup={settingsSvg} {...props} />;
}

export function FocusModeOnIcon(props: IconProps) {
  return <InlineSvgIcon markup={focusModeOnSvg} {...props} />;
}

export function FocusModeOffIcon(props: IconProps) {
  return <InlineSvgIcon markup={focusModeOffSvg} {...props} />;
}

export function ListIcon(props: IconProps) {
  return <InlineSvgIcon markup={listSvg} {...props} />;
}

export function BellIcon(props: IconProps) {
  return <InlineSvgIcon markup={bellSvg} {...props} />;
}

export function BellOffIcon(props: IconProps) {
  return <InlineSvgIcon markup={bellOffSvg} {...props} />;
}

export function LoadingIcon(props: IconProps) {
  return <InlineSvgIcon markup={loadingSvg} {...props} />;
}
...
export function VolumeOffIcon(props: IconProps) {
  return <InlineSvgIcon markup={volumeOffSvg} {...props} />;
}

export function PlayIcon(props: IconProps) {
  return <InlineSvgIcon markup={playSvg} {...props} />;
}

export function ChevronLeftIcon(props: IconProps) {
  return <InlineSvgIcon markup={chevronLeftSvg} {...props} />;
}

export function ChevronRightIcon(props: IconProps) {
  return <InlineSvgIcon markup={chevronRightSvg} {...props} />;
}
...
export function EmailIcon(props: IconProps) {
  return <InlineSvgIcon markup={emailSvg} {...props} />;
}

export function InstagramIcon(props: IconProps) {
  return <InlineSvgIcon markup={instagramSvg} {...props} />;
}

export function YoutubeIcon(props: IconProps) {
  return <InlineSvgIcon markup={youtubeSvg} {...props} />;
}

export function WhatsappIcon(props: IconProps) {
  return <InlineSvgIcon markup={whatsappSvg} {...props} />;
}
